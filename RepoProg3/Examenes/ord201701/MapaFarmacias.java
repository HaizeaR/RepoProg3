...
//	}
//	
	public static void crearTablas(String nombreBD) throws SQLException, ClassNotFoundException {
		
		System.out.println("ConexiÃ³n abierta");
		Class.forName("org.sqlite.JDBC"); // Carga la clase de BD para sqlite
		Connection conexion = DriverManager.getConnection("jdbc:sqlite:" + nombreBD);
		Statement statement = conexion.createStatement();
		String sent = "CREATE TABLE IF NOT EXIST farmacia (  localidad varchar(20), horaDesde int(10), horaHasta int(10), zona varchar(20) , direccion varchar(60), telefono int(9)"; 
	...
	public static boolean insertarDatos(FarmaciaGuardia f) {
		
		try (Statement statement = conexion.createStatement()) {
			

			String sent1 = "insert into farmacia values(" + "'" 
					+ f.getLocalidad() + "', " + "'"
					+ f.getHoraDesde() + "', " + "'" 
					+ f.getHoraHasta() + "', " + "'" 
					+ f.getZona() + "', " + "'" 
			...
			int insertados = statement.executeUpdate(sent1);
	...
	// recorrer el mapa y por cada elemento del mapa hacer un insert 
	// meter este metodo dentro del del main 
	
	
	
//	public static void insertar(HashMap<String, ArrayList<FarmaciaGuardia>> mapa) {
//		
//
